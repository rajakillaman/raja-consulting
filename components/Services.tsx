const services = [
  ...
  },
  {
    ...
    credits: 10,
    description:
      "Identify vulnerabilities, misconfigurations, and security risks across your stack.",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    credits: 15,
    description:
      "Tailored technical report on any topic — from infrastructure to DevOps pipelines.",
    icon: (
      <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            ...
            >
              ...
              <div className="inline-block rounded-full bg-accent/10 px-3 py-1 text-xs font-semibold text-accent">
